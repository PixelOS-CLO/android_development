...
describe('ViewerScreenshot', () => {
  ...
  beforeEach(async () => {
    ...
    viewer = new ViewerScreenshot(traces, new InMemoryStorage());
  ...
  it('does not add component output listener for onOverlayMediaBasedTraceChange', async () => {
